...
function App() {
  const[cards, updateCards] = useState([
    ...
    { name: 'The Lost', clicked: false, src: 'https://static.wikia.nocookie.net/bindingofisaacre_gamepedia/images/8/89/Transition_Lost_Tainted.png/revision/latest?cb=20210826045000'},
