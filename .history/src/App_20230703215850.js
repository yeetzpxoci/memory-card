...
function App() {
  ...
  const[cards, updateCards] = useState([
    ...
    { name: 'Apollyon', clicked: false, src: 'https://www.spriters-resource.com/resources/sheet_icons/86/88871.png?updated=1487622175'},
  ...
  return (
    <div>
      ...
      <CardContainer cards={cards} randomizeCards={randomizeCards} cardClicked={cardClicked}>
      </CardContainer>
    </div>
  );
}
