...
function App() {
  const[cards, updateCards] = useState([
    { name: 'Isaac', clicked: false, src: 'https://static.wikia.nocookie.net/bindingofisaacre_gamepedia/images/e/e5/Character_Isaac_appearance.png/revision/latest?cb=20210818221550'},
