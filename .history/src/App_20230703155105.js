...
function App() {
  const[cards, updateCards] = useState([
    { name: 'Isaac', clicked: false, src: 'https://cdn2.steamgriddb.com/file/sgdb-cdn/icon_thumb/7f975a56c761db6506eca0b37ce6ec87.png'},
    { name: 'Magdalene', clicked: false, src: 'https://static.wikia.nocookie.net/bindingofisaac/images/0/09/Magdalene.png/revision/latest?cb=20150318160120&path-prefix=pl'},
